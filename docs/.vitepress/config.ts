    ...
    ar: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("ar", {
          ...
          "reference/keybindings": "روابط مفاتيح Tui",
          "project": "المشروع",
    ...
    de: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("de", {
          ...
          "reference/keybindings": "Tui-Tastenkombinationen",
          "project": "Projekt",
    ...
    es: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("es", {
          ...
          "reference/keybindings": "Combinaciones de teclas de Tui",
          "project": "Proyecto",
    ...
    fr: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("fr", {
          ...
          "reference/keybindings": "Raccourcis clavier Tui",
          "project": "Projet",
    ...
    hi: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("hi", {
          ...
          "reference/keybindings": "टुई कीबाइंडिंग्स",
          "project": "परियोजना",
    ...
    ja: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("ja", {
          ...
          "reference/keybindings": "TUIキーバインド",
          "project": "プロジェクト",
    ...
    ko: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("ko", {
          ...
          "reference/keybindings": "TUI 키바인딩",
          "project": "프로젝트",
          "project/roadmap": "로드맵",
    ...
    ne: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("ne", {
          ...
          "reference/keybindings": "टुई किबाइन्डिङहरू",
          "project": "परियोजना",
    ...
    ru: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("ru", {
          ...
          "reference/keybindings": "Привязки клавиш TUI",
          "project": "Проект",
    ...
    zh: {
      ...
      themeConfig: {
        ...
        sidebar: sidebar("zh", {
          ...
          "reference/keybindings": "Tui 键位绑定",
          "project": "项目",
          "project/roadmap": "路线图",
