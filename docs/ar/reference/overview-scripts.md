...
- **Hyprland**: *Hyprland هو محرر Wayland بلاط ديناميكي يدعم الميزات الحديثة مثل الرسوم المتحركة وتأثيرات النوافذ وتخطيطات البلاط المرنة. يتيح لك السكريبت تثبيت إعدادات Hyprland المُعدة مسبقاً من مستخدمين محترمين - ml4w، end-4، Jakoolit وnqpts prasanthrangan.*
