...
- **التحديث**: يتبع نفس طريقة التثبيت التي استخدمتها في الأصل: cargo أو cargo-binstall أو سكربت التثبيت.
- **إلغاء التثبيت**: اختيار "cargo" سيزيل أيضاً الملفات الثنائية المثبتة بواسطة `cargo binstall`، حيث كلاهما يثبت في `~/.cargo/bin/`.
