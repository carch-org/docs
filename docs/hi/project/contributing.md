...
> ```
> 
> वैसे, commit करने से पहले, अगर आप किसी `.sh` या bash script फ़ाइल को बदल रहे हैं, तो `scripts/` डायरेक्टरी चेक करें और `./check.sh` चलाएं ताकि अतिरिक्त सफेद या खाली जगहें मिल सकें। अगर यह फेल हो जाए, तो `./cleanup.sh` चलाएं। यह भी सुनिश्चित करें कि स्क्रिप्ट्स `shfmt` से फ़ॉर्मैट की गई हों।
