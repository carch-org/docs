...
> Rust फ़ाइल परिवर्तनों के लिए, `cargo fmt --all --check` चलाना सुनिश्चित करें। यदि कोई सुझाव हैं, तो `cargo fmt --all` चलाएं।
> यह भी सुनिश्चित करें कि `cargo clippy` और `cargo clippy -- -D warnings` चलाएं ताकि कोई त्रुटि न बची हो। धन्यवाद।
