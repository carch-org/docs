...
> ```sh
> modules/
> ├── Browser/     # ब्राउजर सम्बन्धित स्क्रिप्टहरू
> ├── Desktop/     # डेस्कटप वातावरण सम्बन्धित स्क्रिप्टहरू
...
> [!IMPORTANT]
> पहिले, कुनै पनि परिवर्तन गर्नु अघि **स्क्रिप्ट कसरी काम गर्छ भनेर विश्लेषण गर्नुहोस्**। यदि तपाईं परियोजनामा सुधार वा थप्न चाहनुहुन्छ भने, **संरचना** र प्रत्येक भागले कसरी अन्तरक्रिया गर्छ भनेर बुझ्नुहोस्। यसले तपाईंलाई परियोजनाको डिजाइनसँग सुसंगत तरिकामा योगदान गर्न मद्दत गर्नेछ।
>
> ```sh
> कमिट गर्नका लागि, यस्ता लेबलहरू प्रयोग गर्नुहोस्
> feat: your-commit-message वा fix: your-commit-message।
> ```
> 
> btw, commit गर्नु अघि तपाईंले कुनै `.sh` वा bash स्क्रिप्ट फाइल परिवर्तन गर्दै हुनुहुन्छ भने `scripts/` डाइरेक्टरी जाँच गर्नुहोस् र `./check.sh` चलाएर अनावश्यक खाली ठाउँ जाँच गर्नुहोस्। यदि असफल भयो भने `./cleanup.sh` चलाउनुहोस्। साथै, स्क्रिप्टहरू `shfmt` द्वारा फर्म्याट गरिएको छ भनी सुनिश्चित गर्नुहोस्।
> Rust फाइल परिवर्तनको लागि `cargo fmt --all --check` चलाउनुहोस्। यदि सुझाव आए भने `cargo fmt --all` चलाउनुहोस्।  
> साथै `cargo clippy` र `cargo clippy -- -Dwarnings` चलाउनुहोस् सुनिश्चित गर्न कि कुनै त्रुटि बाँकी छैन। धन्यवाद।
