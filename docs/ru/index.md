...
hero:
  ...
  tagline: Простой скрипт для упрощения настройки Linux 🧩
  actions:
    - theme: brand
...
> [!IMPORTANT]
> ***Carch в настоящее время работает только на*** **дистрибутивах на основе Arch и Fedora**. ***Он не будет работать на других дистрибутивах.***
