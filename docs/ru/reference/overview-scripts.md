...
- **Hyprland**: *Hyprland — динамический тайлинговый композитор Wayland с поддержкой современных функций: анимаций, эффектов окон и гибкой компоновки. Скрипт позволяет установить готовые конфигурации Hyprland от авторитетных пользователей: ml4w, end-4, Jakoolit и prasanthrangan.*
