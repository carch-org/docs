...
- **Q 2024**: Разработать дополнительные скрипты настройки WM и скрипты настройки основной системы. <img src="https://cdn-icons-png.flaticon.com/128/190/190411.png" width="20" />
- **Q середина 2025/2026**: Рефакторинг существующих скриптов для стабильности и начало расширения поддержки дистрибутивов. <img src="https://cdn-icons-png.flaticon.com/128/190/190406.png" width="20" />
    - Разработать TUI на базе Rust для улучшенного взаимодействия с пользователем. 🦀 <img src="https://cdn-icons-png.flaticon.com/128/190/190411.png" width="20" />